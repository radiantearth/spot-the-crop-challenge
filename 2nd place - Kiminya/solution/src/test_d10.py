...
TOP_FEATURES = ['ARI','AVI','B01','B02','B05','B06','B09','B11','B12','CLM','BNDVI','BSI','CVI','FE2',
'GBNDV2','GNDVI','GRNDV2','RBNDVI','MSAVI','MYVI','NBR','NDMI','NDRE','NDSI','NDVI',
'NGRDI','NPCRI','PSRI','SLAVI','TCARI','TCI','WDRVI','SI']
def get_features_s2(df,versions=[0,1,2]):
    ...
    drop_feats = [f for f in feat_cols if f not in TOP_FEATURES]
